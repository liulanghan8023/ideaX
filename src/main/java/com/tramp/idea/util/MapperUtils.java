...
import com.tramp.idea.dom.model.*;
...
public final class MapperUtils {
	...
	public static PsiElement createMapperFromFileTemplate(@NotNull String fileTemplateName, @NotNull String fileName, @NotNull PsiDirectory directory,
