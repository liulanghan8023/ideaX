package com.tramp.idea.setting;

import static com.tramp.idea.generate.StatementGenerator.*;
...
import com.tramp.idea.generate.GenerateModel;
import com.tramp.idea.generate.StatementGenerator;

/**
 * @author yanglin
 */
//@State(name = "MybatisSettings", storages = @Storage(id = "other", file = "$APP_CONFIG$/mybatis.xml"))
