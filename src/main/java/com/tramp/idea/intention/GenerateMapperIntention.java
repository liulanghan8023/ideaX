...
import com.tramp.idea.livetemplate.MybatisFileTemplateDescriptorFactory;
import com.tramp.idea.service.EditorService;
import com.tramp.idea.ui.ClickableListener;
...
public class GenerateMapperIntention extends GenericIntention {
	...
	private void handleMutilDirectories(Project project, final Editor editor, final PsiClass clazz, Collection<PsiDirectory> directories) {
		...
		uiComponentFacade.showListPopupWithSingleClickable("Choose folder", popupListener, "Choose another", getChooseFolderListener(editor, clazz),
